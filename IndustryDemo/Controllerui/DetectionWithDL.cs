...
namespace IndustryDemo.Controllerui
{
...

    {
        ...
        public void ImageProcess(string picDir)

        {
            ...
            try
            {
                ...
                hv_ExampleDataDir.Dispose();
                hv_ExampleDataDir = Global.deepLearningModelDir + "/" + "segment_filter_defects_data";
                //
            ...
            try
            {
                        ...
                        )) - 1); hv_ClassIndex = (int)hv_ClassIndex + 1)
                {
                        ...
                        0))) != 0)
                    {
                        ...
                        //待编程： 将图片名称、瑕疵类型，瑕疵位置x，y，写入数据库表defection
                ...
                for (hv_BatchIndex = 0; hv_BatchIndex.Continue(end_val84, step_val84); hv_BatchIndex = hv_BatchIndex.TupleAdd(step_val84))
                {
                            ...
                            )) - 1); hv_ClassIndex = (int)hv_ClassIndex + 1)
                    {
                            ...
                            0))) != 0)
                        {
                            ...
                            MySqlCommand cmd2;
                            if (hv_Area.TupleSelect(0) <= 150000)
                            {
                                conn.Open();
                                string Query3 = "insert into defection(qrcode,picName,picX,picY,trayX,trayY,defectionType,area) values('" + Global.qrCode + "','" + hv_BaseName + "','" + picx + "','" + picy + "','" + trayx + "','" + trayy + "','" + hv_ClassNames[hv_ClassIndex] + "','" + hv_Area.TupleSelect(0) + "');";
