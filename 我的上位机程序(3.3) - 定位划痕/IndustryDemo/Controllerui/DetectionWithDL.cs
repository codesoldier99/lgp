                ...
                for (hv_BatchIndex = 0; hv_BatchIndex.Continue(end_val84, step_val84); hv_BatchIndex = hv_BatchIndex.TupleAdd(step_val84))
                {
                            ...
                            )) - 1); hv_ClassIndex = (int)hv_ClassIndex + 1)
                    {
                            ...
                            0))) != 0)
                        {
                            ...
                            {
                                conn.Open();
                                string Query3 = "insert into defection(qrcode,picName,picX,picY,trayX,trayY,defectionType,area) value('" + Global.qrCode + "','" + hv_BaseName + "','" + picx + "','" + picy + "','" + trayx + "','" + trayy + "','" + hv_ClassNames[hv_ClassIndex] + "','" + hv_Area.TupleSelect(0) + "');";
