...

        {
            ...
            try
            {
               ...
               // hv_ImageDir = "xiamen";
                ...
                hv_ExampleDataDir.Dispose();
                hv_ExampleDataDir = "F:/codetest/DLtest/work/segment_filter_defects_data";
                //
                ...
                hv_ImageFiles.Dispose();
                list_image_files("F:/codetest/testimg",
              ...
              //以下循环抛出异常
                ...
                for (hv_ClassIndex = 0; (int)hv_ClassIndex <= (int)((new HTuple(hv_Areas.TupleLength()
                        )) -1); hv_ClassIndex = (int)hv_ClassIndex + 1)
                    {
                        ...
                        string Query2 = "insert into defection(picName,picX,picY) value('" + hv_BaseName + "','" + zx + "','" + zy+ "');";
