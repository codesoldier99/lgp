...
namespace IndustryDemo
{
    public partial class pictureshow : Form
    {
        ...
        public void panelOpticalfilter2(string picname, int FRow, int FCol)
        {
            ...
            //在放大的滤光片图绘制3x3九宫格黑线
            float gridX1 = panelControl1.Width / 3f;
            float gridX2 = panelControl1.Width * 2f / 3f;
            float gridY1 = panelControl1.Height / 3f;
            float gridY2 = panelControl1.Height * 2f / 3f;
            using (Pen gridPen = new Pen(Color.Black, 1))
            {
                gra1.DrawLine(gridPen, gridX1, 0, gridX1, panelControl1.Height);
                gra1.DrawLine(gridPen, gridX2, 0, gridX2, panelControl1.Height);
                gra1.DrawLine(gridPen, 0, gridY1, panelControl1.Width, gridY1);
                gra1.DrawLine(gridPen, 0, gridY2, panelControl1.Width, gridY2);
            }
